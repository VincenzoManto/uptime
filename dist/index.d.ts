...
export declare function errorTrackerExpress(route?: string): (import("express-serve-static-core").Router | ((err: any, req: Request, _res: Response, next: NextFunction) => Promise<void>))[];
